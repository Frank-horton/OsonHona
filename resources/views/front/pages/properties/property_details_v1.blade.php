                                ...
                                <div class="sidebar1-area">
                                    <div class="details-siderbar2">
                                        ...
                                        <div class="personal-info">
                                            <div class="img1">
                                                <img src="{{ $response['data']['user']['profile'] != '' ? $response['data']['user']['profile'] : 'https://e7.pngegg.com/pngimages/178/595/png-clipart-user-profile-computer-icons-login-user-avatars-monochrome-black.png' }}" onerror="this.onerror=null;this.src='https://e7.pngegg.com/pngimages/178/595/png-clipart-user-profile-computer-icons-login-user-avatars-monochrome-black.png';" alt="housa" style="height: 50px; width: 100px; border-radius: 50%; object-fit: fill;">
                                            </div>
                                            <div class="content">
                                                <a href="#">
